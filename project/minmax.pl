...
minmax(0,[X|_],Move,Move,_,_,_,_) :- element(2,CurrentScore,X), Score is CurrentScore.
...
minmax(Depth, [X|_], Move, Result, max, Player, Board, Score) :- NewDepth is Depth-1, 
														...
														minmax(NewDepth, NewPossibleMoves, Move, Result, min, NewPlayer, NewBoard, Score),
